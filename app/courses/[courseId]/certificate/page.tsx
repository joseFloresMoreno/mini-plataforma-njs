    ...
    <div className="min-h-screen bg-slate-100 p-4 sm:p-8 flex flex-col items-center justify-center">
      ...
      <div className="no-print mb-8 flex w-full max-w-4xl justify-between gap-4 items-center">
        <Link
          ...
          className="inline-flex h-10 items-center justify-center rounded-full border border-slate-300 bg-white px-5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 shadow-sm"
        >
          ← Volver al curso
        </Link>
        <button
      ...
      <div className="print-container relative w-full max-w-4xl rounded-3xl border-8 border-double border-amber-600 bg-[#fffdf6] p-8 sm:p-16 text-center shadow-xl overflow-hidden">
        ...
        <div className="space-y-6 sm:space-y-8">
          <div>
            ...
            <h1 className="mt-4 font-serif text-3xl sm:text-5xl font-extrabold uppercase tracking-wide text-amber-800">
              Certificado de Finalización
            </h1>
            <div className="h-1 w-24 bg-amber-600 mx-auto mt-4" />
          </div>

          <p className="text-sm sm:text-base font-medium tracking-wider text-slate-500 uppercase">
            Este certificado se otorga con honor a
          </p>

          <h2 className="font-serif text-3xl sm:text-5xl font-bold italic text-slate-800 border-b-2 border-slate-200 pb-2 max-w-xl mx-auto">
            {data.user.name}
          </h2>
          ...
          <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-8 items-end max-w-3xl mx-auto">
            ...
            <div className="flex justify-center py-2 sm:py-0">
              <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-amber-600 shadow-md border-4 border-white">
